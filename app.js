...
app.use(cors());
//database ka har ek document aisa dikhegaa
const postSchema = {
  title: String,
  body: String
};
...
app.get("/posts/:postId", function (req, res) {
  ...
  blog.findOne({ _id: requestedPostId }, function (err, searchedBlog) {
    if (!err) {
      res.render("post", {
        blogTitle: searchedBlog.title,
        blogContent: searchedBlog.body
      })
    }
  })
});
